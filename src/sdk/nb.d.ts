...
interface NativeFile {
    ...
    read_rdma(fs_context: NativeFSContext, length: number, pos: number, rdma_info: RdmaInfo): Promise<number>;
    write_rdma(fs_context: NativeFSContext, length: number, pos: number, rdma_info: RdmaInfo): Promise<number>;
}
