...
class NamespaceFS {
    ...
    async read_object_stream(params, object_sdk, res) {
        ...
        try {
            ...
            if (params.rdma_info) {
                const size = await rdma_utils.read_rdma_buffer(params.rdma_info, file_reader, multi_buffer_pool);
                res.setHeader('Content-Length', 0);
                rdma_utils.set_rdma_response_header(null, res, params.rdma_info, { size });
            } else {
    ...
    async _upload_stream({ fs_context, params, target_file, object_sdk, offset }) {
        ...
        try {
            ...
            if (copy_source) {
                ...
                await rdma_utils.write_rdma_buffer(params.rdma_info, file_writer, multi_buffer_pool);
            } else {
