 ...
 * @param {Buffer} server_buf = info[2]
 * @param {number} server_offset = info[3]
 * @param {string} client_buf_desc = info[4]
 * @param {number} client_offset = info[5]
 * @param {number} max_length = info[6]
 */
Napi::Value
